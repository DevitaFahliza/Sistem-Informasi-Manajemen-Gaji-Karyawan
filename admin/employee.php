                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                        <tr>
                          ...
                          <!-- Menampilkan foto karyawan atau foto default jika tidak ada -->
                          ...
                          <!-- Menampilkan jadwal kerja dalam format waktu yang mudah dibaca -->
...
$(function(){
  ...
  // Ketika tombol photo diklik, tampilkan modal edit photo
