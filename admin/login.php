...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    // Ganti dengan logika autentikasi yang benar
    if($username == 'admin' && $password == 'password'){ // Contoh: username dan password yang valid
        $_SESSION['admin'] = $username; // Simpan username dalam sesi
        header('location: home.php');
        exit();
    } else {
